...
[📖 快速开始](#-快速开始) · [🔌 插件生态](#-插件生态) · [🛠️ 开发指南](https://github.com/MiCat-S/Mi-Box/blob/main/TELEBOX_DEVELOPMENT.md) · [📋 安装](https://github.com/MiCat-S/Mi-Box/blob/main/INSTALL.md)
...
> 完整规范见 [TELEBOX_DEVELOPMENT.md](https://github.com/MiCat-S/Mi-Box/blob/main/TELEBOX_DEVELOPMENT.md)
...
[![Plugin Repository](https://img.shields.io/badge/🔌_插件仓库-TeleBox--Plugins-blue?style=for-the-badge)](https://github.com/MiCat-S/Mi-Box-Plugins)
...
[![安装指南](https://img.shields.io/badge/📋_完整安装指南-INSTALL.md-green?style=for-the-badge)](https://github.com/MiCat-S/Mi-Box/blob/main/INSTALL.md)

</div>

```bash
git clone https://github.com/MiCat-S/Mi-Box.git ~/telebox
...
| | |
|:--:|:--:|
| [![TeleBox](https://img.shields.io/badge/📦_TeleBox-blue?style=for-the-badge&logo=github)](https://github.com/MiCat-S/Mi-Box) | [![TeleBox-Next](https://img.shields.io/badge/📦_TeleBox--Next-blue?style=for-the-badge&logo=github)](https://github.com/TeleBoxOrg/TeleBox-Next) |
| [![Plugins](https://img.shields.io/badge/🔌_TeleBox--Plugins-green?style=for-the-badge&logo=github)](https://github.com/MiCat-S/Mi-Box-Plugins) | [![Issues](https://img.shields.io/badge/🆘_Issues-red?style=for-the-badge&logo=github)](https://github.com/MiCat-S/Mi-Box/issues) |
