  ...
  private async handleHelp(msg: Api.Message) {
    try {
      ...
      if (args.length === 0) {
        ...
        const links = `🔗 <a href='https://github.com/TeleBoxOrg/TeleBox'>📦仓库</a> | <a href='https://github.com/MiCat-S/TeleBox-Plugins/tree/codex-reasoning-effort-source'>🔌插件</a> | <a href='https://t.me/teleboxdevgroup'>👥群组</a> | <a href='https://t.me/teleboxdev'>📣频道</a> | <a href='https://telegra.ph/TeleBox-插件列表-03-03'>📚插件列表</a>`;
